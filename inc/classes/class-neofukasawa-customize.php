...
if (!class_exists('NeoFukasawa_Customize')) {
	class NeoFukasawa_Customize
	{
		public static function register($wp_customize)
		{
			...
			$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'neofukasawa_accent_color', array(
				'label' 	=> __('Accent Color', 'neofukasawa'),
				'section' 	=> 'colors',
			...
			// Only display the Customizer section for the neofukasawa_logo setting if it already has a value.
			...
			if (get_theme_mod('neofukasawa_logo')) {
				$wp_customize->add_section('neofukasawa_logo_section', array(
					'title'       => __('Logo', 'neofukasawa'),
					'priority'    => 40,
					'description' => __('Upload a logo to replace the default site title in the sidebar/header', 'neofukasawa'),
				));
				...
				$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'neofukasawa_logo', array(
					'label'    => __('Logo', 'neofukasawa'),
					'section'  => 'neofukasawa_logo_section',
					'settings' => 'neofukasawa_logo',
				)));
			}
		}
		...
		public static function header_output()
		{
			...
			self::generate_css('.widget_neofukasawa_recent_posts a:hover .title', 'color', 'accent_color');
	...
	add_action('customize_register', array('NeoFukasawa_Customize', 'register'));

	// Output custom CSS to live site
	add_action('wp_head', array('NeoFukasawa_Customize', 'header_output'));
}
