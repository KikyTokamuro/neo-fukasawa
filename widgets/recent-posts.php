...
class neofukasawa_recent_posts extends WP_Widget
{

	function __construct()
	{
		$widget_ops = array(
			'classname' 	=> 'widget_neofukasawa_recent_posts',
			'description' 	=> __('Displays recent blog entries.', 'neofukasawa')
		);
		parent::__construct('widget_neofukasawa_recent_posts', __('Recent Posts', 'neofukasawa'), $widget_ops);
	}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php _e('Title:', 'neofukasawa'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number_of_posts'); ?>"><?php _e('Number of posts to display:', 'neofukasawa'); ?>
			...
			<small>(<?php _e('Defaults to 5 if empty', 'neofukasawa'); ?>)</small>
		</p>

<?php
	}
}
register_widget('neofukasawa_recent_posts'); ?>