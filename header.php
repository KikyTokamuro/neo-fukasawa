...
<body <?php body_class(); ?>>
	...
	<a class="skip-link button" href="#site-content"><?php _e('Skip to the content', 'neofukasawa'); ?></a>
	...
	<div class="sidebar">
		...
		$legacy_logo_url 	= get_theme_mod('neofukasawa_logo');
		...
		<button type="button" class="nav-toggle">
			...
			<p>
				<span class="menu"><?php _e('Menu', 'neofukasawa'); ?></span>
				<span class="close"><?php _e('Close', 'neofukasawa'); ?></span>
			</p>
		...
		<div class="credits">
			...
			<p><?php _e('Powered by', 'neofukasawa'); ?> <a href="https://wordpress.org">WordPress</a>.</p>
			<p><?php _e('Theme by', 'neofukasawa'); ?> <a href="https://kikytokamuro.space/">Kiky Tokamuro</a>.</p>
		</div><!-- .credits -->
