...
<div class="archive-container">
	...
	<h3><?php _e('Posts', 'neofukasawa'); ?></h3>
	...
	<h3><?php _e('Categories', 'neofukasawa') ?></h3>

	<ul>
		<?php wp_list_categories('title_li='); ?>
	</ul>

	<h3><?php _e('Tags', 'neofukasawa') ?></h3>
	...
	<h3><?php _e('Contributors', 'neofukasawa'); ?></h3>

	<ul>
		<?php wp_list_authors(); ?>
	</ul>

	<h3><?php _e('Archives by Year', 'neofukasawa'); ?></h3>

	<ul>
		<?php wp_get_archives('type=yearly'); ?>
	</ul>

	<h3><?php _e('Archives by Month', 'neofukasawa'); ?></h3>

	<ul>
		<?php wp_get_archives('type=monthly'); ?>
	</ul>

	<h3><?php _e('Archives by Day', 'neofukasawa'); ?></h3>
