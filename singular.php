			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('entry post single'); ?>>
				...
				if (!post_password_required()) :
					...
					elseif ($post_format == 'gallery') : ?>
						...
						<figure class="featured-media clear">
							<?php neofukasawa_flexslider('post-image'); ?>
						</figure><!-- .featured-media -->
				...
				<div class="post-inner">
					...
					<div class="post-content entry-content">
						...
						if (!is_single()) {
							edit_post_link(__('Edit post', 'neofukasawa'), '<p>', '</p>');
						}
					...
					$link_pages = wp_link_pages($args = array(
						'before'           => '<p class="page-links"><span class="title">' . __('Pages:', 'neofukasawa') . '</span>',
						'after'            => '</p>',
						'link_before'      => '<span>',
						'link_after'       => '</span>',
						'separator'        => '',
						...
						<div class="post-meta-bottom clear">
							...
							if (is_single()) : ?>
								...
								<ul>
									...
									<?php if (has_category()) : ?>
										<li class="post-categories"><?php _e('In', 'neofukasawa'); ?> <?php the_category(', '); ?></li>
									<?php endif; ?>
									...
									<?php edit_post_link(__('Edit post', 'neofukasawa'), '<li>', '</li>'); ?>
								</ul>
					...
					<div class="post-navigation clear">
						...
						if ($prev_post) : ?>
							<a class="post-nav-prev" href="<?php echo get_permalink($prev_post->ID); ?>">
								<p>&larr; <?php _e('Previous post', 'neofukasawa'); ?></p>
							</a>
						<?php endif; ?>

						<?php if ($next_post) : ?>
							<a class="post-nav-next" href="<?php echo get_permalink($next_post->ID); ?>">
								<p><?php _e('Next post', 'neofukasawa'); ?> &rarr;</p>
							</a>
						<?php endif; ?>
